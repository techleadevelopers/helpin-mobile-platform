...
export const MOCK_ONGS: ONG[] = [
  {
    ...
    shortName: 'IAA',
    description: 'Maior rede de proteçío animal do Brasil, com 12 anos de atuaçío e mais de 15 mil animais resgatados.',
    mission: 'Resgatar, tratar e recolocar animais em lares amorosos.',
    location: 'Vila Mariana, Sío Paulo, SP',
    city: 'Sío Paulo',
    state: 'SP',
    verified: true,
    ...
    cause: 'Adoçío responsável e resgate urbano',
  },
  {
    id: 'o2',
    name: 'ONG Patinhas Felizes',
    shortName: 'Patinhas',
    description: 'Especializada no resgate e reabilitaçío de animais vítimas de maus-tratos na Grande Sío Paulo.',
    ...
    cause: 'Combate a maus-tratos e adoçío',
  },
  {
    id: 'o3',
    name: 'Abrigo Municipal SP',
    shortName: 'AMSP',
    description: 'Abrigo público conveniado com a Prefeitura de Sío Paulo, capacidade para 200 animais com suporte veterinário completo.',
    mission: 'Zelar por animais abandonados e promover adoçío consciente.',
    location: 'Mooca, Sío Paulo, SP',
    city: 'Sío Paulo',
    state: 'SP',
    verified: true,
  ...
  },
  {
    ...
    shortName: 'RAB',
    description: 'Atua em emergências e desastres naturais para resgatar e acolher animais em situaçío de risco extremo.',
  ...
  },
  {
    ...
    shortName: 'FABR',
    description: 'Conecta doadores a ONGs verificadas, garantindo transparência total no uso dos recursos para proteçío animal.',
    mission: 'Financiar a proteçío animal com transparência e impacto real.',
    location: 'Pinheiros, Sío Paulo, SP',
    city: 'Sío Paulo',
    state: 'SP',
    verified: true,
    animalsRescued: 0,
    ...
    cause: 'Captaçío e distribuiçío de recursos',
  },
];
...
export const MOCK_POSTS: Post[] = [
  ...
  },
  {
    ...
    breed: '',
    age: '',
    description: 'Atençío moradores do bairro Mooca! Estamos vendo um aumento de animais soltos na Rua das Acácias. Por favor, se você tiver raçío sobrando ou puder adotar temporariamente, entre em contato. Juntos salvamos mais vidas 🐾',
    location: 'Sío Paulo, SP',
    neighborhood: 'Mooca',
    image: null,
    textOnly: true,
  ...
  },
  {
    ...
    type: 'adoption',
    animalType: 'other',
    name: 'Feira de Adoçío',
    breed: '',
    age: '',
    description: 'Sábado tem Feira de Adoçío no Parque Villa-Lobos! Das 9h às 17h, com mais de 40 animais à espera de um lar. Venha com a família, entrada gratuita. Apoio veterinário no local para check-up na hora 🐶🐱',
    location: 'Sío Paulo, SP',
    ...
    createdAt: '3h atrás',
    contact: '(19) 98888-0002',
    tags: ['feira', 'adoçío', 'villalobos', 'sábado'],
  },
  {
    id: '4',
    type: 'found',
  ...
  },
  {
    ...
    type: 'campaign',
    animalType: 'other',
    name: 'Campanha Raçío Solidária',
    breed: 'Todos os animais',
    age: 'Vários',
    description: 'Nosso abrigo está com estoque de raçío crítico. Temos 85 animais para alimentar. Precisamos de doações de raçío ou financeiras. Cada ajuda faz diferença!',
    location: 'Sío Paulo, SP',
    neighborhood: 'Mooca',
    image: null,
    textOnly: false,
    ...
    createdAt: '1 dia atrás',
    contact: '(11) 94444-0006',
    tags: ['campanha', 'doaçío', 'raçío', 'abrigo'],
  },
  {
    id: 'post1',
    type: 'post',
  ...
  },
  {
    ...
    breed: '',
    age: '',
    description: 'Hoje completou 6 meses que adotei a Lua pelo ZooHelp. O que antes era um gatinho assustado que se escondia debaixo da cama hoje me acorda com ronronar e dorme no meu travesseiro. Adoçío transforma — a vida do animal e a sua 🐱',
    location: 'Sío Paulo, SP',
  ...
  },
  {
    ...
    breed: '',
    age: '',
    description: 'Boa notícia! Conseguimos vacinar 47 animais de rua neste fim de semana graças ao mutirío de voluntários. Obrigado a todos que apareceram cedo na praça. Próxima açío será em 15 dias — salve na agenda! 🏥🐶🐱',
    location: 'Sío Paulo, SP',
    neighborhood: 'Vila Mariana',
    image: null,
    textOnly: true,
    ...
    createdAt: '4h atrás',
    contact: '(11) 99999-0001',
    tags: ['vacinaçío', 'voluntários', 'açío', 'comunidade'],
  },
];
...
export const MOCK_CONVERSATIONS: ChatConversation[] = [
  ...
  },
  {
    ...
    lastMessage: 'Quero contribuir com raçío. Como faço?',
    lastMessageTime: 'Ontem',
    unread: 1,
    postTitle: 'Campanha Raçío Solidária',
  },
];

export const POST_TYPE_CONFIG: Record<PostType, { label: string; color: string; bgColor: string }> = {
  adoption: { label: 'Adoçío', color: '#FFFFFF', bgColor: '#4CAF50' },
