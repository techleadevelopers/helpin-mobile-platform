...
export const MOCK_POSTS: Post[] = [
  ...
  },
  {
    ...
    age: '2 anos',
    description: 'Mel é uma cachorrinha muito dócil e carinhosa. Vacinada, castrada e com microchip. Adora crianças e se dá bem com outros cíes. Busca um lar cheio de amor e carinho.',
  ...
  },
  {
    ...
    breed: 'Poodle mix',
    age: '1 ano',
    description: 'Pipoca é um cío alegre e brincalhío. Resgatado das ruas quando filhote. Está saudável, vacinado e pronto para um novo lar. Aceitamos famílias com crianças.',
    ...
    tags: ['vacinado', 'resgatado', 'brincalhío'],
  },
  {
    id: '6',
    type: 'campaign',
  ...
  },
  {
    ...
    breed: '',
    age: '',
    description: 'Lembrete importante: cíes precisam de água fresca disponível o dia todo, especialmente no verío. Parece óbvio, mas muitos tutores esquecem de trocar a água diariamente. Um gesto simples que pode salvar a vida do seu pet 🐾',
    location: 'São Paulo, SP',
    neighborhood: 'Pinheiros',
    image: null,
    textOnly: true,
  ...
  },
  {
    ...
    breed: '',
    age: '',
    description: 'Hoje completou 6 meses que adotei a Lua pelo Helpin. O que antes era um gatinho assustado que se escondia debaixo da cama hoje me acorda com ronronar e dorme no meu travesseiro. Adoção transforma — a vida do animal e a sua 🐱',
    location: 'São Paulo, SP',
  ...
  },
  {
    ...
    breed: '',
    age: '',
    description: 'Boa notícia! Conseguimos vacinar 47 animais de rua neste fim de semana graças ao mutirío de voluntários. Obrigado a todos que apareceram cedo na praça. Próxima ação será em 15 dias — salve na agenda! 🏥🐶🐱',
    location: 'São Paulo, SP',
    neighborhood: 'Vila Mariana',
    image: null,
    textOnly: true,
