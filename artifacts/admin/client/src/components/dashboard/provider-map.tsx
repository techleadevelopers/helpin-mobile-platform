    ...
    <Card className="shadow-floating border-0">
      <CardHeader className="flex flex-col gap-3">
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg font-semibold">Mapa de Resgates</CardTitle>
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Buscar ONGs e clínicas por nome"
              className="pl-9"
              value={searchTerm}
        ...
        >
          ...
          {!isLoading && !isError && providerPoints.length === 0 && (
            <div className="absolute inset-0 flex items-center justify-center text-sm text-gray-600 pointer-events-none">
              Nenhum ONG ou clínica encontrado para os filtros atuais.
            </div>
          )}
        </div>
      </CardContent>
