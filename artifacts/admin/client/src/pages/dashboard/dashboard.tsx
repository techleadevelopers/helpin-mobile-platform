    ...
    <div className="flex h-screen bg-admin-bg">
      ...
      <div className="flex-1 ml-72 overflow-hidden">
        <Header
          ...
          subtitle="Monitore ONGs, clínicas, resgates, trust, doações e sponsors em tempo real."
        />
        ...
        <main className="flex-1 overflow-y-auto p-8">
          ...
          {/* Linha 2 — Doações + Resumo de ONGs/Clínicas */}
          <div className="grid grid-cols-12 gap-6 mb-8">
          ...
          {/* Linha 3 — Mapa de resgates e rede de apoio */}
          <div className="grid grid-cols-12 gap-6 mb-8">
            <div className="col-span-12">
