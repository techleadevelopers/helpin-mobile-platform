        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="title" value={formData.title || ''} onChange={handleInputChange} placeholder="Ex: Primeiro resgate coordenado" />
            </div>
            <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select value={formData.targetAudience} onValueChange={(value: MissionTargetAudience) => handleSelectChange('targetAudience', value)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value={MissionTargetAudience.NEW_CLIENTS}>Novos Usu�rios</SelectItem>
                  <SelectItem value={MissionTargetAudience.SPECIFIC_PROVIDER}>ONG/Cl�nica Específico</SelectItem>
            ...
            {formData.targetAudience !== MissionTargetAudience.ALL && (
              <div className="space-y-2">
                ...
                <Input id="targetId" value={formData.targetId || ''} onChange={handleInputChange} placeholder="ID do cliente/ONG ou cl�nica/serviço" />
              </div>
            )}
          </div>
