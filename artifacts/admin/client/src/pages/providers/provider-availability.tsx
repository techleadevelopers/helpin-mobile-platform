  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        <Header title="Disponibilidade do ONG/Clínica" subtitle="Edite horÃ¡rios semanais dos ONGs e clínicas." />
        <main className="p-6 space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Selecionar ONG/Clínica</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="flex items-center gap-3">
                <Input placeholder="Provider ID" value={providerId} onChange={(e) => setProviderId(e.target.value)} className="max-w-md" />
                <span className="text-sm text-gray-500">ou copie do catÃ¡logo de ONGs e clínicas</span>
              </div>
              {!!selected && (
