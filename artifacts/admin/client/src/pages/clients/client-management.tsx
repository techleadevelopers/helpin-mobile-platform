        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
              ...
              <TabsContent value="dashboard" className="pt-4">
                ...
                <p className="text-gray-500">Dados do dashboard do cliente (KPIs, casos recentes, cupons, missões) seriam carregados aqui.</p>
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    <p className="text-sm text-gray-500">Casos Cancelados</p>
    ...
    <div className="flex h-screen bg-admin-bg">
      ...
      <div className="flex-1 ml-72 overflow-hidden">
        <Header 
          ...
          subtitle="Visualize e gerencie os usuários usu�rios da plataforma LimpeJá."
        />
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.2 }}>
              <Card className="shadow-floating border-0">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Com Casos</p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.3 }}>
              <Card className="shadow-floating border-0">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Usu�rios Gold</p>
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-4 flex-1">
                  <div className="relative flex-1 max-w-md">
                    <Input
                      type="text"
                      placeholder="Buscar usu�rios por nome, e-mail ou CPF..."
                      value={searchTerm}
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-4 text-sm text-gray-500 mt-1">
                                ...
                                <span>Casos Concluídos: {client.completedBookingsCount}</span>
                              </div>
                            </div>
                          </div>
