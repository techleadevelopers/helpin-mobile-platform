    ...
    <div className="flex h-screen bg-admin-bg">
      ...
      <div className="flex-1 ml-72 overflow-hidden">
        <Header
          ...
          subtitle="Monitoramento em tempo real dos casos confirmados e em andamento."
        />
        <main className="p-8 overflow-y-auto space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="rounded-xl border border-dashed border-gray-200 bg-white p-4">
                  <p className="text-xs uppercase text-gray-500">Casos monitorados</p>
          ...
          <Card className="border-0 shadow-floating">
            ...
            <CardContent className="overflow-x-auto">
              {isLoading ? (
                <div className="py-16 text-center text-sm text-gray-400">Carregando casos...</div>
              ) : isError ? (
