...
return (
    <div className="flex h-screen bg-admin-bg">
      ...
      <div className="flex-1 ml-72 overflow-hidden">
        <Header 
          title="Gerenciamento de Moderação"
          subtitle="Monitore e resolva conflitos entre usuários e ONGs e clínicas."
        />
              ...
              <Card className="glass-card shadow-floating border-0">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Total de Moderação</p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.1 }}>
              <Card className="glass-card shadow-floating border-0">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Moderação Pendentes</p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.3 }}>
              <Card className="glass-card shadow-floating border-0">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Moderação Resolvidas</p>
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-4 flex-1">
                  <div className="relative flex-1 max-w-md">
                    <Input
                      type="text"
                      placeholder="Buscar casos de abuso por ID, motivo ou descrição..."
                      value={searchTerm}
            ...
            <CardContent className="pt-6">
              {isLoading ? (
                ...
                <div className="text-center py-12 text-red-600">
                  <p>Erro ao carregar casos de abuso: {error?.message}</p>
                </div>
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-4 text-sm text-gray-600">
                                <span>Caso ID: {dispute.bookingId.substring(0, 8)}...</span>
