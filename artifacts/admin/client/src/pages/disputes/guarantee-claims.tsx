...
// Componente de Modal para Detalhes e AçÃµes da Reclamação de Garantia
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-sm text-gray-500">ID do Caso</p>
              ...
              <div>
                <p className="text-sm text-gray-500">ID do ONG/Clínica</p>
  ...
  return (
    <div className="flex h-screen bg-admin-bg">
      ...
      <div className="flex-1 ml-72 overflow-hidden">
        <Header 
          title="Gerenciamento de ReclamaçÃµes de Garantia"
          subtitle="Monitore e resolva solicitaçÃµes de garantia de serviço."
        />
              ...
              <Card className="shadow-floating border-0">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">Total de ReclamaçÃµes</p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.1 }}>
              <Card className="shadow-floating border-0">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">ReclamaçÃµes Pendentes</p>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.3 }}>
              <Card className="shadow-floating border-0">
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-600">ReclamaçÃµes Resolvidas</p>
              ...
              <div className="flex items-center justify-between gap-4">
                <div className="flex items-center gap-4 flex-1">
                  <div className="relative flex-1 max-w-md">
                    <Input
                      type="text"
                      placeholder="Buscar reclamações por ID do caso, usuário, ONG/clínica ou descrição..."
                      value={searchTerm}
            ...
            <CardContent className="pt-6">
              {isLoading ? (
                ...
                <div className="text-center py-12 text-red-600">
                  <p>Erro ao carregar reclamaçÃµes: {error?.message}</p>
                </div>
                          ...
                          <div className="flex items-center space-x-4">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-4 text-sm text-gray-600">
                                <span>Caso ID: {claim.bookingId.substring(0, 8)}...</span>
                                <span>Cliente: {claim.clientId.substring(0, 8)}...</span>
                                <span>ONG/Clínica: {claim.providerId.substring(0, 8)}...</span>
                              </div>
