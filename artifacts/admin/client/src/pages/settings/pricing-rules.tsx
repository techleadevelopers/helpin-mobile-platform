                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        >
                            ...
                            <option value="PROVIDER">ONG/Cl�nica</option>
                        </select>
                    </div>
                    {formState.scope && formState.scope !== 'GLOBAL' && (
                        <div>
                            <label htmlFor="refId" className="block text-sm font-medium text-gray-700">ID de Referência (Cidade/Categoria/Serviço/ONG/Cl�nica)</label>
                            <input
                                type="text"
                                id="refId"
                                name="refId"
