                  ...
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="admin-email" defaultValue="admin@zoohelp.org" type="email" />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        defaultValue="Plataforma de resgate, ado��o, doa��es e trust para prote��o animal."
                        className="h-24"
                      />
                    </div>
              ...
              >
                <Card className="shadow-floating border-0"> 
                  ...
                  <CardContent className="space-y-8">
                    <div>
                      <h3 className="text-sm font-semibold text-gray-700 mb-3">Modera��o (horas)</h3>
                ...
                <Card className="shadow-floating border-0">
                  ...
                  <CardContent className="space-y-6">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="space-y-1">
                          <Label>Novas ONGs e cl�nicas</Label>
                          <p className="text-sm text-gray-600">Receber notifica��es quando novas ONGs ou cl�nicas entram na rede</p>
                        </div>
                ...
                <Card className="shadow-floating border-0">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="from-email" defaultValue="noreply@zoohelp.org" type="email" />
                    </div>
