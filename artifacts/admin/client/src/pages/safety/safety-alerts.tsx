                                                ...
                                                >
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex-1">
                                                            ...
                                                            {alert.bookingId && <p className="text-sm text-gray-600">Caso ID: {alert.bookingId}</p>}
                                                ...
                                                >
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex-1">
                                                            ...
                                                            {incident.bookingId && <p className="text-sm text-gray-600">Caso ID: {incident.bookingId}</p>}
                                                            <div className="flex items-center gap-4 text-sm text-gray-500 mt-1">
