import { randomUUID } from "crypto"; // randomUUID n√£o √© mais necess√°rio se n√£o for usado para gerar IDs
...
export interface Provider {
  ...
  createdAt: Date; // Mantido como Date para mocks, mas ser√° string para API real
  updatedAt: Date; // Mantido como Date para mocks, mas ser√° string para API real
...
export const mockProviders: Provider[] = [
  {
    ...
    city: "S√£o Paulo", // Adicionado
    specialties: ["Resgate urbano", "Lar tempor·rio"], // Adicionado
  ...
  },
  {
    ...
    specialties: ["Atendimento veterin·rio"], // Adicionado
  ...
  },
  {
    ...
    specialties: ["Resgate urbano", "Transporte solid·rio"], // Adicionado
...
export const mockActivities: Activity[] = [
  ...
  },
  {
    ...
    description: "Service booking completed: Resgate urbano",
    entityId: "booking1",
    entityType: "BOOKING",
    status: "COMPLETED",
...
export const mockServices: Service[] = [
  {
    id: "service1",
    name: "Resgate urbano B√°sica",
    description: "Kit de apoio para resgate com transporte, triagem veterin·ria e lar tempor·rio",
    basePrice: "120.00",
    isActive: true,
    createdAt: new Date("2023-01-15")
  },
  {
    id: "service2",
    name: "Lar tempor·rio",
    description: "Rede de lares tempor·rios para animais em risco",
    basePrice: "250.00",
    isActive: true,
  ...
  {
    id: "service3",
    name: "Atendimento veterin·rio",
    description: "Atendimento veterin·rio parceiro para casos verificados",
    basePrice: "180.00",
    isActive: true,
...
// As fun√ß√µes utilit√°rias mockadas ser√£o removidas, pois a API real as substituir√°.
